...
window.addEventListener('load', function (e) {
    try {
        var args = {
            ...
            // autofocus_current_word: document.getElementById('autofocus_current_word').checked
        };
        ...
        // document.getElementById('autofocus_current_word').addEventListener('change', function (e) {
        //     ReadAlong.autofocus_current_word = this.checked;
        // }, false);

        // document.querySelector('.chair_audio').hidden = false;
        if (supports_playback_rate) {
            document.querySelector('.playback-rate').hidden = false;
        }
        // document.querySelector('.autofocus_current_word').hidden = false;
    }
    catch (err) {
        console.error(err);
    }
